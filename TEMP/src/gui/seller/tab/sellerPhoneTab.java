	...
	public sellerPhoneTab(Seller seller) {
		...
		btnNewData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				MODEL_NAME = JOptionPane.showInputDialog("모델 이름");
				if (MODEL_NAME != null) {
					CPU_INFO = JOptionPane.showInputDialog("CPU");
					if (CPU_INFO != null) {
						DISPLAY = JOptionPane.showInputDialog("화면 크기");
						if (DISPLAY != null) {
							RAM = JOptionPane.showInputDialog("RAM");
							if (RAM != null) {
								STORAGE = JOptionPane.showInputDialog("용량");
								if (STORAGE != null) {
									PRICE = JOptionPane.showInputDialog("가격");
									if (PRICE != null) {
										PERFORMANCE = JOptionPane.showInputDialog("프리미엄 or 보급");
										if (PERFORMANCE != null) {
											MANUFACTURE = JOptionPane.showInputDialog("1-애플 2-삼성 3-LG");
											if (MANUFACTURE != null) {
		...
		list.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent evt) {
				...
				if (evt.getClickCount() == 2) {
					...
					MODEL_NAME = JOptionPane.showInputDialog(sellerPhoneTab.this, "모델 이름",
							selected.getMODEL_NAME());
					if (MODEL_NAME != null) {
						CPU_INFO = JOptionPane.showInputDialog(sellerPhoneTab.this, "CPU", selected.getCPU_INFO());
						if (CPU_INFO != null) {
							DISPLAY = JOptionPane.showInputDialog(sellerPhoneTab.this, "화면크기",
									selected.getDISPLAY());
							if (DISPLAY != null) {
								RAM = JOptionPane.showInputDialog(sellerPhoneTab.this, "RAM", selected.getRAM());
								if (RAM != null) {
									STORAGE = JOptionPane.showInputDialog(sellerPhoneTab.this, "용량",
											selected.getSTORAGE());
									if (STORAGE != null) {
										PRICE = JOptionPane.showInputDialog(sellerPhoneTab.this, "가격",
												selected.getPRICE());
										if (PRICE != null) {
											PERFORMANCE = JOptionPane.showInputDialog(sellerPhoneTab.this,
													"프리미엄 or 보급", selected.getPERFORMANCE());
											if (PERFORMANCE != null) {
												MANUFACTURE = JOptionPane.showInputDialog(sellerPhoneTab.this,
														"1-애플 2-삼성 3-LG", selected.getMANUFACTURE());
												if (MANUFACTURE != null) {
