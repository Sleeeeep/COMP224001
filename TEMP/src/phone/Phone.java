...
public class Phone {
	...
	public Phone(String MODEL_NAME, String CPU_INFO, String DISPLAY, String RAM, String STORAGE, String PRICE,
			String PERFORMENCE, String MANUFACTURE) {
	...
	public Phone(Phone original) {
		setMODEL_NAME(original.getMODEL_NAME());
		setCPU_INFO(original.getCPU_INFO());
		setDISPLAY(original.getDISPLAY());
		setRAM(original.getRAM());
		setSTORAGE(original.getSTORAGE());
		setPRICE(original.getPRICE());
		setPERFORMANCE(original.getPERFORMANCE());
		setMANUFACTURE(original.getMANUFACTURE());
	}
